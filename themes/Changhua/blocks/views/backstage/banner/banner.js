...
var sender = {
  ...
  init: function() {
    ...
    sender.settings['url'] += getCA()+'/'+srvPath + 'attach/65327';
...
ctrl.pic_delete = function(cnID) {
      var req = {url: 'changhua/changhua/changhua/unattach/'+cnID, hasCA: true};
    __.api(req, function(data) {
      if (data.errCode === 0) {
        alert('刪除成功!');
		window.location.reload();
